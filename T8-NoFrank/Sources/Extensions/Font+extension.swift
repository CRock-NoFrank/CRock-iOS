...
extension Font {
    ...
    static let subtitleMedium: Font = .custom(
        Pretendard.medium.rawValue,
        size: 19
    )
    ...
    static let subheadlineMedium: Font = .custom(
        Pretendard.medium.rawValue,
        size: 17
    )
    static let caption1Medium: Font = .custom(
        Pretendard.medium.rawValue,
        size: 15
    )

    static let caption1SemiBold: Font = .custom(
        Pretendard.semiBold.rawValue,
        size: 15
    )
